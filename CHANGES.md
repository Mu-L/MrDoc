...
- [新增] 支持AI知识库功能，支持AI问答、AI文档编写；
- [新增] 用户token获取图片列表接口；
- [新增] 用户Token获取和上传附件接口；
- [新增] 支持添加robots.txt和llms.txt文件；
- [修复] 长文档内容下尾部图片在PDF打印时不显示的问题；
- [修复] 修改文档时提示获取下级文档失败的问题；
- [修复] 文集导出的路径穿越漏洞，感谢LingXisec团队提供安全审查；
- [修复] 修改文档时对文集权限的验证问题；
- [修复] 异步文集目录文档连接错误的问题；
- [修复] 文集序列化器字段导致一些未使用接口暴露文集敏感信息的问题；
- [优化] 支持docker镜像内gunicorn模式运行；
- [优化] 文集目录相关接口的权限验证；

### v1.0.0 2026-06-03

- [新增] 文集文档树中包含下级文档的文档可配置为「点击标题展开目录」形式；
- [新增] 文集权限支持配置登录用户可见；
- [新增] 支持导入Word文件为文集功能；
- [优化] 富文本文档标签属性过滤白名单;
- [优化] 移除已废弃的zip文集导入代码；
- [优化] 更新docker Compose镜像版本；
- [优化] 优化富文本类型文档内容的XSS过滤；
- [优化] 用户TokenAPI获取文档相关接口返回文档排序值字段；
- [优化] 文集和文档页面顶部工具栏；
- [优化] 优化首页页头样式；
- [优化] 用户Token获取个人文档列表接口kw搜索范围包含文档内容；
- [优化] 用户Token获取文集文档层级列表接口支持分页参数；
- [优化] 用户Token修改文档接口不再需要pid参数；
- [修复] 修复导出EPUB的路径穿越漏洞，感谢LingXisec反馈；
- 
